...
class DotTabView @JvmOverloads constructor(private val mContext: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : RelativeLayout(mContext, attrs, defStyleAttr) {
    ...
    fun setViewPager2(viewPager: ViewPager2?, tabCount: Int,totalCount:Int,scrollType:Int,dWidth: Int, dotType:Int,selectColor: Int, unSelectColor: Int) {
    ...
    private fun createView(tabCount: Int, dWidth: Int, selectColor: Int, unSelectColor: Int,dotType:Int) {
